  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          { label: 'Total Campaign', value: filteredPromos.length, sub: 'aktif & arsip', color: 'text-indigo-600' },
          { label: 'Total Redemption', value: insights.totalRedemption.toLocaleString(), sub: insights.growthWoW, color: 'text-emerald-600' },
          { label: 'Campaign Reach', value: insights.campaignReach, sub: 'effectiveness', color: 'text-violet-600' },
        ].map(stat => (
          <div key={stat.label} className="bg-white rounded-[28px] border border-gray-100 shadow-sm p-6">
